...
function animate() 
{
	...
	if(game_over == false)
	{
		...
		displayScoreText("Score: " + (snakeLen - 4));
		display();
	}
	else
	{
		displayGameOverText("GAME OVER!!! Refresh to play again!");
	}
...
function displayScoreText(text)
{
	context.font = "30px Arial";
	context.fillText(text, 50, 50);
}

function displayGameOverText(text)
{
	context.font = "30px Arial";
	context.fillText(text, 250, 400);
}
